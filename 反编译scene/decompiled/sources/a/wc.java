...
public class wc {
    ...
    public wc(char c, float[] fArr) {
        this.f7773a = c;
        this.f3420a = fArr;
    }

    public wc(wc wcVar) {
        this.f7773a = wcVar.f7773a;
        float[] fArr = wcVar.f3420a;
        this.f3420a = xc.c(fArr, 0, fArr.length);
    }
    ...
    public static void e(wc[] wcVarArr, Path path) {
        float[] fArr = new float[6];
        char c = 'm';
        for (int i = 0; i < wcVarArr.length; i++) {
            a(path, fArr, c, wcVarArr[i].f7773a, wcVarArr[i].f3420a);
            c = wcVarArr[i].f7773a;
        }
    }

    public void d(wc wcVar, wc wcVar2, float f) {
        this.f7773a = wcVar.f7773a;
        int i = 0;
        while (true) {
            float[] fArr = wcVar.f3420a;
            ...
            this.f3420a[i] = (fArr[i] * (1.0f - f)) + (wcVar2.f3420a[i] * f);
            i++;
        }
    }
}
