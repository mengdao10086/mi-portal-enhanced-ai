...
public abstract class ik {
    ...
    */
    public static <L, T> T c(L r7, a.gk<L, T> r8, a.fk<T> r9, T r10, android.graphics.Rect r11, int r12) {
        /*
        ...
        L64:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: a.ik.c(java.lang.Object, a.gk, a.fk, java.lang.Object, android.graphics.Rect, int):java.lang.Object");
    }

    public static <L, T> T d(L l, gk<L, T> gkVar, fk<T> fkVar, T t, int i, boolean z, boolean z2) {
        int iA = gkVar.a(l);
        ArrayList arrayList = new ArrayList(iA);
        for (int i2 = 0; i2 < iA; i2++) {
            arrayList.add(gkVar.b(l, i2));
        }
        Collections.sort(arrayList, new hk(z, fkVar));
        if (i == 1) {
