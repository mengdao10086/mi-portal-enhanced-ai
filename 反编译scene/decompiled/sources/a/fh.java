...
public abstract class fh {
    ...
    public static Method f6104a;

    static {
        if (Build.VERSION.SDK_INT == 25) {
            try {
                f6104a = ViewConfiguration.class.getDeclaredMethod("getScaledScrollFactor", new Class[0]);
    ...
    public static float a(ViewConfiguration viewConfiguration, Context context) {
        Method method;
        if (Build.VERSION.SDK_INT >= 25 && (method = f6104a) != null) {
            try {
